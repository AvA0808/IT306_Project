...
public abstract class Exercise {
	...
	public static final String[] MUSCLE_GROUP = {"(Top of Shoulders) Deltoids", "Shoulders", "(Upper Back) Trapezius", "(Lower Back) Erector Spinae", "Chest", 
			"(Lats) Latissimus Dorsi", "Biceps", "Triceps", "Forearms", "Abs", "Obliques", "Quadriceps", "Hamstrings", "Calves"};
